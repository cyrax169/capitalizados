...
<table border="0" align="center" bgcolor="#D0D0D0" >
               <thead>
                   <tr>
                       <th height="65"><font color="#CC0000">Aceptar registro de cliente</font></th>
                       <th></th>
                   </tr>
               </thead>
               <tbody>
                   <?php        $result2 = mysqli_query($conn,"SELECT * FROM cliente  WHERE  cliente_activo='0' ORDER BY nombres ASC");
