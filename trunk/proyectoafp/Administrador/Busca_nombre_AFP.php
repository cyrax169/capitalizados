...
<table border="0" align="center" bgcolor="#D0D0D0" >
               <thead>
                   <tr>
                       <th height="65"><font color="#CC0000">Búsqueda de cliente por AFP</font></th>
                       <th></th>
                   </tr>
               </thead>
               <tbody>
                 <tr>
                       ...
                       <td><select name="nombre_seleccionado">
                        ...
                        <?php        $result2 = mysqli_query($conn,"SELECT * FROM cliente  WHERE afp=$afp and cliente_activo='1' ORDER BY nombres ASC");
